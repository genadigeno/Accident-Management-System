...
public class KafkaConfig {
    ...
    /**
     * On unrecoverable errors, publishes the original record (key, value bytes and headers preserved)
     * to the dead-letter topic, enriched with DLT_* origin and exception headers
